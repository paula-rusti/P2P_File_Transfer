...
int main()
{
    ...
    memcpy(TEST_FILE_LIST[2].hash, "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD", 32);
    memcpy(TEST_FILE_LIST[2].name, "file_4dddd", 10);
    TEST_FILE_LIST[2].size = 19312;

    server_t *peer_server = server_constructor("127.0.0.1", 5001, 5);
